...
export default function MobileBottomNav() {
  ...
  return (
    <nav 
      ...
      className="md:hidden fixed bottom-3 left-4 right-4 z-50 bg-[#121612]/80 backdrop-blur-xl border border-[#7fee64]/25 rounded-2xl px-3 py-2 shadow-[0_8px_32px_rgba(0,0,0,0.6)]"
    >
      <div className="flex items-center justify-around max-w-md mx-auto">
        <Link
          href="/#work"
          className="flex flex-col items-center justify-center min-w-[52px] min-h-[44px] px-2 py-1 text-[#8cab87] active:text-[#7fee64] transition-colors group"
        >
        ...
        <button
          onClick={openWizard}
          className="-mt-5 bg-[#7fee64] text-[#000000] w-13 h-13 rounded-full shadow-[0_0_22px_rgba(127,238,100,0.45)] border-2 border-[#121612] flex flex-col items-center justify-center active:scale-95 transition-transform"
