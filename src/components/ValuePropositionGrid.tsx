...
const cards = [
  {
    icon: <RocketIcon />,
    title: 'Landing Page',
    desc: 'Para lanzar productos o campañas y convertir visitas en clientes en 2 a 3 semanas.',
  },
  {
    icon: <BuildingIcon />,
    title: 'Página Web Corporativa',
    desc: 'Para darle autoridad a tu empresa con una vitrina profesional 24/7.',
  },
  {
    icon: <CpuIcon />,
    title: 'Sistema Web a Medida',
    desc: 'Para automatizar procesos y llevar la gestión de tu negocio al siguiente nivel.',
  }
];
      ...
      <div className="max-w-[1360px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {cards.map((card, idx) => (
            <div 
              key={idx} 
              className="bg-[#181818] rounded-lg border border-[#485346] p-[32px] transition-all duration-300 hover:border-[#677d64] hover:shadow-[0_0_30px_rgba(127,238,100,0.06)] flex flex-col justify-between"
            >
              <div>
