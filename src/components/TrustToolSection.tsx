    ...
    <section id="process" className="w-full bg-[#000000] py-24 px-6 md:px-12 lg:px-20 border-t border-[#1f2a33]">
      <div className="max-w-[1360px] mx-auto">
        ...
        <div className="max-w-3xl mb-16">
          ...
          >
            Tu página web es el activo que demuestra el nivel real de tu marca.
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {steps.map((step) => (
            <div
              key={step.number}
              className="bg-[#181818] rounded-lg border border-[#485346] p-8 flex flex-col justify-between transition-colors hover:border-[#677d64]"
            >
              <div>
        ...
        {/* Trust Callout */}
        <div className="mt-12 p-8 rounded-lg bg-[#181818] border border-[#7fee64]/30 flex flex-col md:flex-row items-center justify-between gap-6">
